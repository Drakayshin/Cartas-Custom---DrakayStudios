...
function s.initial_effect(c)
	--  *El nombre de esta carta se convierte en "Yacard, Héroe de la Fábula" en Campo o Cementerio
...
s.listed_names={291}
-- =========================================================
-- EFECTO 1: Main Phase (Efecto Rápido)
-- =========================================================
...
-- =========================================================
-- EFECTO 2: Comienzo de la Fase de Batalla
-- =========================================================
-- Filtro para monstruos que mencionen "Yacard, Héroe de la Fábula" (ID 291), excluyendo a esta carta
...
function s.sptg2(e,tp,eg,ep,ev,re,r,rp,chk)
    ...
    if chk==0 then 
        return Duel.GetLocationCount(tp,LOCATION_MZONE)>=2 and not Duel.IsPlayerAffectedByEffect(tp,CARD_BLUEEYES_SPIRIT)
            ...
            and Duel.IsExistingMatchingCard(s.mentionfilter,tp,LOCATION_DECK|LOCATION_GRAVE|LOCATION_REMOVED,0,1,nil,e,tp) 
    end
...
function s.spop2(e,tp,eg,ep,ev,re,r,rp)
    ...
    if Duel.SpecialSummon(c,0,tp,tp,false,false,POS_FACEUP)~=0 then
        ...
        local g=Duel.SelectMatchingCard(tp,s.mentionfilter,tp,LOCATION_DECK|LOCATION_GRAVE|LOCATION_REMOVED,0,1,1,nil,e,tp)
        if #g>0 then
