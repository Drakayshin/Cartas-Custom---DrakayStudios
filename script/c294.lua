...
function s.thfilter(c)
    -- c:GetType()==TYPE_SPELL verifica si es SOLO Mágica Normal (excluye continuas, campo, etc.)
    -- c:IsEquipSpell() verifica si es de Equipo (corrección aplicada de lecciones pasadas)
