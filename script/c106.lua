...
function s.eqval(ec,c,tp)
	return ec:IsControler(tp) and ec:IsSetCard(0xdd)
end
...
--ATK UP
function s.val(e,c)
	return Duel.GetMatchingGroupCount(Card.IsRace,c:GetControler(),LOCATION_GRAVE+LOCATION_MZONE,0,nil,RACE_DRAGON)*300
end
--special summon Blue-eyes
...
function s.spfilter(c,e,tp)
	return c:IsSetCard(0xdd) and not c:IsCode(id) and c:IsRace(RACE_DRAGON) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
