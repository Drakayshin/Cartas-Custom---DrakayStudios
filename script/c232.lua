...
function s.cfilter(c)
	return c:IsSetCard(0x3ee) and c:IsMonster() and c:IsAbleToRemoveAsCost()
end
...
function s.thsetfilter(c)
	return c:IsSetCard(0x3ee) and c:IsTrap() and (c:IsAbleToHand() or c:IsSSetable())
end
