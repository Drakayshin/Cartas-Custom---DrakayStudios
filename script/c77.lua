...
function s.initial_effect(c)
    ...
    c:RegisterEffect(e0)
	--  1° Añadir 1 monstruo de OSCURIDAD o "Terranigma" en el Cementerio a la mano con posible Invocación de Modo Normal
...
function s.addfilter(c)
	return c:IsAttribute(ATTRIBUTE_DARK) or (c:IsMonster() and c:IsSetCard(0x3e7)) and c:IsAbleToHand()
end
