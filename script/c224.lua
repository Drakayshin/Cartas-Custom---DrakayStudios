...
function s.initial_effect(c)
	...
	e0:SetHintTiming(1,id,EFFECT_COUNT_CODE_OATH)
	c:RegisterEffect(e0)
...
function s.tgop(e,tp,eg,ep,ev,re,r,rp)
	...
	-- Recuperar y robar
function s.filter(c)
	return c:IsSetCard(0x182) and c:IsAbleToDeck()
end
