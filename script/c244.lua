...
function s.spfilter(c,e,tp)
	return c:IsSetCard(0x3ee) and (c:IsFaceup() or c:IsLocation(LOCATION_HAND|LOCATION_GRAVE)) and c:IsLevelBelow(9) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
