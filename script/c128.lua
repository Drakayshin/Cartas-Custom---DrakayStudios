...
function s.initial_effect(c)
	...
	-- 	0° Activar 1 carta de Campo desde tu Deck
	...
	c:RegisterEffect(e0)
	-- 	1° Tu adversario no seleccina por efectos tus cartas
	...
	c:RegisterEffect(e1)
    -- 	2° Invocar 1 monstruo que mencione El Sello de Oricalcos
	...
	-- 	3° Invocar a "Defensor de Oricalcos"
...
function s.filter1(c,e,tp)
	return c:IsCode(129) and c:IsCanBeSpecialSummoned(e,0,tp,true,false)
end
