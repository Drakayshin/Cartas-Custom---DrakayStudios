...
s.listed_series={0x41,0x3ec}
	-- Buscar cartas
function s.filter1(c)
	return c:IsSetCard(0x41) and c:IsAbleToHand()
end
function s.filter2(c)
	return  not c:IsCode(id) and c:IsAbleToHand() and c:IsSpellTrap() and (c:IsSetCard(0x3ec) or c:IsCode(25290459) or c:IsCode(61850482) or c:IsCode(88089103) or c:IsCode(90500169))
end
