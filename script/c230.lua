...
function s.initial_effect(c)
    ...
    c:RegisterEffect(e0)
    --  1° Invocar de Modo Especial esta carta desde tu mano con posible Invocación de 1 monstruo "Flamante"
...
function s.thfilter(c)
	return c:IsSetCard(0x3ee) and c:IsType(TYPE_TUNER) and not c:IsCode(id) and c:IsAbleToHand()
end
