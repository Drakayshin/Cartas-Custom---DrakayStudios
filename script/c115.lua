...
function s.initial_effect(c)
	...
	c:RegisterEffect(e1)
	-- 	2° No puede ser seleecionado por tu adversario o ser destruido por efectos de tu adversario
	...
	e2a:SetValue(s.indval)
	c:RegisterEffect(e2a)
	-- 	3° Es tratado como "Blue-Eyes White Dragon" en el Campo o Cementerio
	...
	c:RegisterEffect(e3)
	-- 	4° Destruir 1 carta en el Campo de tu adversario
...
function s.spop(e,tp,eg,ep,ev,re,r,rp,c)
	...
	-- 	*EFECTO 2° (2a° evitar destrucción por efectos del adversario)
