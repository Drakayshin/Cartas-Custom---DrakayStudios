...
function s.initial_effect(c)
	-- 	0° Buscar 1 monstruo Planta desde el Deck
	...
	c:RegisterEffect(e0)
	-- 	1° Tu adversario no puede seleccionar a esta carta para batallar o por efectos de cartas
    ...
    -- 	2° Invocar durante la 2da Stadby Phase 1 monstruo Planta y doblar su ATK/DEF
...
function s.filter(c,e,tp)
	return c:IsRace(RACE_PLANT) and c:IsCanBeSpecialSummoned(e,0,tp,true,false)
end
