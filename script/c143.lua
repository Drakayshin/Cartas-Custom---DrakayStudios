...
function s.initial_effect(c)
	...
	-- 	0° Aumenta 1000 ATK si es Invocado por Péndulo
	...
	c:RegisterEffect(e0)
    -- 	1° Invocar de Modo Especial hasta 2 monstros Dinosaurio, Reptil
...
function s.spop(e,tp,eg,ep,ev,re,r,rp)
	...
	local g=Duel.SelectMatchingCard(tp,aux.NecroValleyFilter(s.spfilter),tp,LOCATION_HAND|LOCATION_DECK,0,1,2,nil,e,tp)
	if #g>0 then
